...
export default {
  ...
  mounted () {
    ...
    // Draw the scene.
    let fRotationRadians = [degToRad(0), degToRad(0)]
    let fieldOfViewRadians = degToRad(60) // 可控制缩放
    let shininess = 150
    let lightRotationRadians = [degToRad(0), degToRad(0)]
    ...
    function drawScene () {
      ...
      mat4.rotateY(worldMatrix, worldMatrix, fRotationRadians[1])
      mat4.rotateX(worldMatrix, worldMatrix, fRotationRadians[0])
      ...
      // let xM4 = mat4.create()
      // let yM4 = mat4.create()
      mat4.targetTo(lightMatrix, lightPosition, target, up)
      mat4.rotateX(lightMatrix, lightMatrix, lightRotationRadians[0])
      mat4.rotateY(lightMatrix, lightMatrix, lightRotationRadians[1])
      // mat4.multiply(lightMatrix, xM4, lightMatrix)
      // mat4.multiply(lightMatrix, yM4, lightMatrix)
      lightDirection = [-lightMatrix[8], -lightMatrix[9], -lightMatrix[10]]
    ...
    function updateCameraAngle (theta, phi) {
      fRotationRadians = [phi, theta]
      drawScene()
    }

    // let amorization = 0.95
    let theta = fRotationRadians[1]
    let phi = fRotationRadians[0]
    let dX = 0
    let dY = 0
    let drag = false
